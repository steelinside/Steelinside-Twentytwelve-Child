...
function twentytwelve_entry_meta() {
	...
	$date = sprintf( '<span style="font-size:.89rem" class="mobile-meta"><time class="entry-date" datetime="%3$s">%4$s</time></span>',
	...
	if ( $tag_list ) {
		$utility_text = __( '
		<span class="meta-part"><span class="icon-clock-o2 small"></span>&thinsp;%3$s</span>
